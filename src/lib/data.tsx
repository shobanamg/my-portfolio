...
export const PROJECTS: ProjectDetails[] = [
  ...
  },
  {
    name: "Meal Sharing",
    description:
      "For my individual project at HackYourFuture, I designed and developed a full-stack web application that allows users to share meals with others. The app allows users to create, read, update, and delete meals and reservations.",
